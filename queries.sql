...
VALUES
  ('2019.02.06', '2019.02.25', '2019.12.01', '0', 'Собеседование в IT компании', NULL, 3, 1),
  ('2019.02.06', '2019.02.26', '2019.12.25', '0', 'Выполнить тестовое задание', NULL, 3, 1),
  ('2019.02.06', '2019.02.27', '2019.12.21', '1', 'Сделать задание первого раздела', NULL, 2, 1),
  ('2019.02.06', '2019.02.28', '2019.12.22', '0', 'Встреча с другом', NULL, 1, 2),
  ('2019.02.06', '2019.03.01', '2019.02.21', '0', 'Купить корм для кота', NULL, 4, 2),
  ('2019.02.06', '2019.03.02', NULL, '0', 'Заказать пиццу', NULL, 4, 2);
